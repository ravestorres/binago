...
<body style="font-family: 'Poppins', sans-serif;">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <form class="d-flex" role="search" method="post">
                            <select class="form-control me-2 border-0" id="inputGroupSelect01" name="searchjobCategory" style="border-radius: 50px;background-color: #F4F4F4;max-width: 20rem;">
 ...
 ```php
            ...
            <div class="d-flex">
                ...
                ?>
                <div class="dropdown">
                    <a class="navbar-brand position-relative" href="#" id="notify" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu border-0 shadow p-2 px-0" aria-labelledby="notify" style="min-width: 18rem; max-height: 600px; overflow-y: auto;">
                        <li class="p-1">
                        ...
                        <li class="my-1 p-2">
                            <div class="d-flex align-items-center">
                                <div class="p-2">
                                    <img src="<?php profilepath($notyprofilePic); ?>" alt="company" class="rounded-circle" style="width: 58px; height: 58px; object-fit: cover">
                                </div>
                                <div class="">
                                    <div class="d-flex">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-2"><?php echo statusdisplay($notystatus); ?></div>
                                    </div>
                                </div>
                            </div>
                            <hr>
                        ...
                        echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>" . $exc->getMessage() . "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button></div>";
                    }
                    ?>
                    </ul>
                </div>
            ...
            <div class="dropdown">
                <div class="" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="<?php profilepath($profilePic); ?>" alt="avatar" class="rounded-circle me-2" style="width: 38px; height: 38px; object-fit: cover" data-bs-toggle="tooltip" data-bs-title="See your profile" data-bs-placement="bottom" /> 
...
<a class="dropdown-item" href="./userProfile.php">
                        <div class="d-flex align-items-center">
                            <img src="<?php profilepath($profilePic); ?>" alt="avatar" class="rounded-circle me-2" style="width: 48px; height: 48px; object-fit: cover" />
                    ...
                    <li><a class="dropdown-item" href="../server/logout.php">
                        <div class="d-flex align-items-censter me-2">
